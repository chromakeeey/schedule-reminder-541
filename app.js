...
const lessonsMonday = [
    { timeStart: [8, 30], timeEnd: [9, 50], name: [names.met] },
...
const lessonsTuesday = [
    ...
    { timeStart: [10, 5], timeEnd: [11, 25], name: [groupLesson(names.mobile, 1), groupLesson(names.pract, 2)] },
    { timeStart: [12, 0], timeEnd: [13, 20], name: [names.lan] },
    { timeStart: [13, 35], timeEnd: [14, 55], name: [groupLesson(names.pract, 1), groupLesson(names.mobile, 2)] },
    { timeStart: [15, 10], timeEnd: [16, 30], name: [groupLesson(names.mobile, 2)] },
]

const lessonsWednesday = [
    { timeStart: [8, 30], timeEnd: [9, 50], name: [groupLesson(names.pract, 1), groupLesson(names.engsoft, 2)] },
    { timeStart: [10, 5], timeEnd: [11, 25], name: [groupLesson(names.engsoft, 1), groupLesson(names.pract, 2)] },
    { timeStart: [12, 0], timeEnd: [13, 20], name: [names.web] },
    { timeStart: [13, 35], timeEnd: [14, 55], name: [names.economic] },
